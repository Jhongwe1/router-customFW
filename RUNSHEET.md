...
**2026-09-01: the block exists** — `bench/2026-09-01/PREDICTIONS-B6-block4.md`,
...
`tools/flrbracket.py run`, not by eye** — and the day before, the same command
is run **without `--go`**. That is a containment test rather than a rehearsal:
