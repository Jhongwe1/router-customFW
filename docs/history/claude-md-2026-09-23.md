<!-- A record, not a state document: never edited.
     This is CLAUDE.md as it stood on 2026-09-23 (sha256 b4ce0005...,
     last changed in 49c56de), moved here verbatim when CLAUDE.md was
     rewritten to rules only. The text below this comment is byte-for-byte
     the old file; tools/docmove.py checks that in CI. -->
