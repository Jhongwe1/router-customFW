# PREDICTIONS — block 44, seating 40 (`P2-4`, seating B: every `P2-3` number measured again, on a clock the host does not slew)

**declared date 2026-09-25** — **twelve power presses**, all on this date, the last
...
**⑧ This card is card B re-dated, and nothing else in it moved.** Card B (block 43) was
frozen for 2026-09-24 and never run: the workstation was suspended from 14:03:43 to
23:34:33 that day (量, the System log: Kernel-Power 42, *Sleep Reason: Application API*;
Power-Troubleshooter 1), and at 23:36 `P1`'s ~35 minutes no longer fit before that
date's midnight (§ 4). This card is card B's text with its date, its block number and
its file names substituted, § 4's sync rule rewritten, and this note added. The script
that made it and the check that every other line is card B's are in
`$FWRE_WORK/rebuild/s110/redate/`. No prediction was re-derived: none depends on the date.
...
🔴 **A Windows clock sync inside the seating is recorded, not avoided (§ 3.8).** Card B
placed its seating between two syncs predicted from the 32,768 s cadence (§ 0 ④), which
holds only while the workstation stays awake; it slept through the first (§ 0 ⑧) and
synced on waking, 2026-09-24 23:35:29 (量, `w32tm`). 推 no sync falls inside this seating:
the next is 2026-09-25 08:41:37 if the cadence restarted at that sync, and the 1,024 s
*Poll Interval* `w32tm` prints after the wake produced none at 23:52:33 (量, read 23:53:35).
Before `Z0`, `w32tm /query /status` must read a *Last Successful Sync Time* at least 10
minutes old (any other reading is a `CORRECTIONS` entry before power); it is read again
after `Z9`, and a later time there refutes the 推. Both readings are kept in the
transcripts' directory (§ 6).
...
is a relative `bench/2026-09-25/…` path.
...
is a new card.
⚠️ **Off-card cells are declared in `bench/2026-09-25/CORRECTIONS-block44.md` before they
...
`LR` = `/usr/bin/python3 tools/looprun.py --mode bench --out-dir bench/2026-09-25 --skip S2,S3,S4 --recipe-override a2c56bc8 --dwell-seconds 2.5`
...
```
CAP --out bench/2026-09-25/Z0-PRE --seconds 3
HOST bench/2026-09-25/Z0-PREC :: ls bench/2026-09-25/Z0-PRE.log bench/2026-09-25/Z0-PRE.timing bench/2026-09-25/Z0-PRE.meta.json && cat bench/2026-09-25/Z0-PRE.meta.json
HOST bench/2026-09-25/Z1-ADDR :: sudo -n ip link set enxfc19286184c9 up ; sudo -n ip addr replace 10.1.1.2/24 dev enxfc19286184c9 ; ip -4 addr show dev enxfc19286184c9
HOST bench/2026-09-25/Z1-EVICT :: cat /proc/sys/net/ipv4/conf/enxfc19286184c9/arp_evict_nocarrier
HOST& bench/2026-09-25/Z0-HC :: HCL run --out bench/2026-09-25/Z0-HC --seconds 18000 --no-sntp --no-windows
HOST bench/2026-09-25/Z0-HCW :: HCL wait bench/2026-09-25/Z0-HC --timeout 20
HOST bench/2026-09-25/Z0-TSD :: sudo -n systemctl stop systemd-timesyncd ; systemctl show -p ActiveState systemd-timesyncd
HOST bench/2026-09-25/Z0-HCG :: sleep 100 ; HCL run --out bench/2026-09-25/Z0-HCG --seconds 60 --no-sntp --no-windows ; HCL report bench/2026-09-25/Z0-HCG
```
...
```
CAP --out bench/2026-09-25/P1-A --esc 180 --esc-period 0.002 --seconds 200
HOST bench/2026-09-25/P1-FL :: FL 10.1.1.1 ; FL 10.1.1.3
HOST& bench/2026-09-25/P1-TCPD :: timeout 300 sudo -n tcpdump -n -tt -i enxfc19286184c9 'icmp or (arp and arp[6:2] = 1 and arp[18:4] = 0 and arp[22:2] = 0) or (arp and arp[6:2] = 2 and ((arp[8:4] = 0x02524c58 and arp[12:2] = 0x4657) or (arp[8:4] = 0x560a0101 and arp[12:2] = 0x01e8)))'
HOST& bench/2026-09-25/P1-HP :: HP --out bench/2026-09-25/P1-HP --target 10.1.1.3 --seconds 900 --icmp --icmp-interval 0.05 --neigh
HOST bench/2026-09-25/P1L :: LR --cell P1L LIMG --iterations 3
CAP --out bench/2026-09-25/P1-RZ --send 'busybox reboot -f' --esc-after 25 --esc-period 0.002 --until '<RealTek>' --seconds 45
HOST bench/2026-09-25/P1Q :: LR --cell P1Q QIMG --iterations 4
CAP --out bench/2026-09-25/P1-TK0 --send 'cat /proc/stat ; cat /proc/interrupts' --idle 3 --seconds 20
CAP --out bench/2026-09-25/P1-M0 --send 'echo map 0 > /proc/rtl819x-spi ; cat /proc/rtl819x-spi-map' --until 'map_lines' --seconds 180
HOST bench/2026-09-25/P1-MB0 :: MB bench/2026-09-25/P1-M0
HOST bench/2026-09-25/P1-HPX :: pkill -INT -f 'P1-HP --target' ; sleep 2 ; tail -n 1 bench/2026-09-25/P1-HP.events
CAP --out bench/2026-09-25/P1-FREE --send 'busybox free ; cat /proc/meminfo' --idle 3 --seconds 30
CAP --out bench/2026-09-25/P1-PS --send 'ps' --idle 3 --seconds 30
CAP --out bench/2026-09-25/P1-N0 --send 'cat /proc/rtl819x-nic' --idle 3 --seconds 30
CAP --out bench/2026-09-25/P1-AC0 --send 'sleep 1 ; cat /proc/rtl865x/asicCounter' --until 'CpuEvent' --seconds 40
HOST& bench/2026-09-25/P1-OFF-HP :: HP --out bench/2026-09-25/P1-OFF-HP --target 10.1.1.3 --seconds 180 --udp-listen 50000
CAP --out bench/2026-09-25/P1-OFF01 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
CAP --out bench/2026-09-25/P1-OFF02 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
CAP --out bench/2026-09-25/P1-OFF03 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
CAP --out bench/2026-09-25/P1-OFF04 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
CAP --out bench/2026-09-25/P1-OFF05 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
CAP --out bench/2026-09-25/P1-OFF06 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
CAP --out bench/2026-09-25/P1-OFF07 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
CAP --out bench/2026-09-25/P1-OFF08 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
CAP --out bench/2026-09-25/P1-OFF09 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
CAP --out bench/2026-09-25/P1-OFF10 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
CAP --out bench/2026-09-25/P1-OFF11 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
CAP --out bench/2026-09-25/P1-OFF12 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
CAP --out bench/2026-09-25/P1-OFF13 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
CAP --out bench/2026-09-25/P1-OFF14 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
CAP --out bench/2026-09-25/P1-OFF15 --send 'sleep 1 ; busybox traceroute -n -m 1 -q 1 -w 2 -p 49999 10.1.1.2' --until ' 1  \*' --seconds 10
HOST bench/2026-09-25/P1-ICMP :: ICMP 10.1.1.3
HOST bench/2026-09-25/P1-NMAP :: timeout 900 nmap -sT -p- -T4 -n --max-retries 1 10.1.1.3
```
...
```
CAP --out bench/2026-09-25/P1-TR1-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/TR1.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat ; cat /proc/rtl819x-nic' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-TR1 :: IPERF -c 10.1.1.3 -p 5201 -t 30 -i 5 -f m
CAP --out bench/2026-09-25/P1-TR1-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/TR1.log ; cat /proc/rtl819x-nic' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-TR2-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/TR2.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat ; cat /proc/rtl819x-nic' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-TR2 :: IPERF -c 10.1.1.3 -p 5201 -t 30 -i 5 -f m
CAP --out bench/2026-09-25/P1-TR2-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/TR2.log ; cat /proc/rtl819x-nic' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-TR3-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/TR3.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat ; cat /proc/rtl819x-nic' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-TR3 :: IPERF -c 10.1.1.3 -p 5201 -t 30 -i 5 -f m
CAP --out bench/2026-09-25/P1-TR3-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/TR3.log ; cat /proc/rtl819x-nic' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-TS1-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/TS1.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat ; cat /proc/rtl819x-nic' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-TS1 :: IPERF -c 10.1.1.3 -p 5201 -t 30 -i 5 -f m -R
CAP --out bench/2026-09-25/P1-TS1-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/TS1.log ; cat /proc/rtl819x-nic' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-TS2-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/TS2.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat ; cat /proc/rtl819x-nic' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-TS2 :: IPERF -c 10.1.1.3 -p 5201 -t 30 -i 5 -f m -R
CAP --out bench/2026-09-25/P1-TS2-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/TS2.log ; cat /proc/rtl819x-nic' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-TS3-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/TS3.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat ; cat /proc/rtl819x-nic' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-TS3 :: IPERF -c 10.1.1.3 -p 5201 -t 30 -i 5 -f m -R
CAP --out bench/2026-09-25/P1-TS3-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/TS3.log ; cat /proc/rtl819x-nic' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-UR1-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/UR1.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat ; cat /proc/rtl819x-nic' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-UR1 :: IPERF -c 10.1.1.3 -p 5201 -t 30 -i 1 -f m -u -l 1400 -b 20M
CAP --out bench/2026-09-25/P1-UR1-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/UR1.log ; cat /proc/rtl819x-nic' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-UR2-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/UR2.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat ; cat /proc/rtl819x-nic' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-UR2 :: IPERF -c 10.1.1.3 -p 5201 -t 30 -i 1 -f m -u -l 1400 -b 20M
CAP --out bench/2026-09-25/P1-UR2-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/UR2.log ; cat /proc/rtl819x-nic' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-UR3-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/UR3.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat ; cat /proc/rtl819x-nic' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-UR3 :: IPERF -c 10.1.1.3 -p 5201 -t 30 -i 1 -f m -u -l 1400 -b 20M
CAP --out bench/2026-09-25/P1-UR3-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/UR3.log ; cat /proc/rtl819x-nic' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-US1-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/US1.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat ; cat /proc/rtl819x-nic' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-US1 :: IPERF -c 10.1.1.3 -p 5201 -t 30 -i 1 -f m -u -l 1400 -b 20M -R
CAP --out bench/2026-09-25/P1-US1-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/US1.log ; cat /proc/rtl819x-nic' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-US2-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/US2.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat ; cat /proc/rtl819x-nic' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-US2 :: IPERF -c 10.1.1.3 -p 5201 -t 30 -i 1 -f m -u -l 1400 -b 20M -R
CAP --out bench/2026-09-25/P1-US2-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/US2.log ; cat /proc/rtl819x-nic' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-US3-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/US3.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat ; cat /proc/rtl819x-nic' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-US3 :: IPERF -c 10.1.1.3 -p 5201 -t 30 -i 1 -f m -u -l 1400 -b 20M -R
CAP --out bench/2026-09-25/P1-US3-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/US3.log ; cat /proc/rtl819x-nic' --idle 3 --seconds 40
```
...
```
CAP --out bench/2026-09-25/P1-DOWN --send 'ifconfig rlx0 down ; cat /proc/interrupts' --idle 3 --seconds 30
CAP --out bench/2026-09-25/P1-ETH4 --send 'ifconfig eth4 10.1.1.4 up ; ifconfig eth4 ; cat /proc/interrupts' --idle 3 --seconds 40
HOST bench/2026-09-25/P1-EPING :: ping -I 10.1.1.2 -c 4 -W 2 -q 10.1.1.4
CAP --out bench/2026-09-25/P1-ER1-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/ER1.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-ER1 :: IPERF -c 10.1.1.4 -p 5201 -t 30 -i 5 -f m
CAP --out bench/2026-09-25/P1-ER1-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/ER1.log' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-ER2-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/ER2.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-ER2 :: IPERF -c 10.1.1.4 -p 5201 -t 30 -i 5 -f m
CAP --out bench/2026-09-25/P1-ER2-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/ER2.log' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-ER3-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/ER3.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-ER3 :: IPERF -c 10.1.1.4 -p 5201 -t 30 -i 5 -f m
CAP --out bench/2026-09-25/P1-ER3-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/ER3.log' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-ES1-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/ES1.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-ES1 :: IPERF -c 10.1.1.4 -p 5201 -t 30 -i 5 -f m -R
CAP --out bench/2026-09-25/P1-ES1-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/ES1.log' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-ES2-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/ES2.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-ES2 :: IPERF -c 10.1.1.4 -p 5201 -t 30 -i 5 -f m -R
CAP --out bench/2026-09-25/P1-ES2-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/ES2.log' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-ES3-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/ES3.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-ES3 :: IPERF -c 10.1.1.4 -p 5201 -t 30 -i 5 -f m -R
CAP --out bench/2026-09-25/P1-ES3-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/ES3.log' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-EU1-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/EU1.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-EU1 :: IPERF -c 10.1.1.4 -p 5201 -t 30 -i 1 -f m -u -l 1400 -b 20M
CAP --out bench/2026-09-25/P1-EU1-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/EU1.log' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-EU2-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/EU2.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-EU2 :: IPERF -c 10.1.1.4 -p 5201 -t 30 -i 1 -f m -u -l 1400 -b 20M
CAP --out bench/2026-09-25/P1-EU2-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/EU2.log' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-EU3-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/EU3.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-EU3 :: IPERF -c 10.1.1.4 -p 5201 -t 30 -i 1 -f m -u -l 1400 -b 20M
CAP --out bench/2026-09-25/P1-EU3-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/EU3.log' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-EV1-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/EV1.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-EV1 :: IPERF -c 10.1.1.4 -p 5201 -t 30 -i 1 -f m -u -l 1400 -b 20M -R
CAP --out bench/2026-09-25/P1-EV1-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/EV1.log' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-EV2-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/EV2.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-EV2 :: IPERF -c 10.1.1.4 -p 5201 -t 30 -i 1 -f m -u -l 1400 -b 20M -R
CAP --out bench/2026-09-25/P1-EV2-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/EV2.log' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-EV3-S0 --send 'iperf3 -s -1 -f k --logfile /tmp/EV3.log > /dev/null 2>&1 & sleep 2 ; ps ; cat /proc/stat' --idle 4 --seconds 30
HOST bench/2026-09-25/P1-EV3 :: IPERF -c 10.1.1.4 -p 5201 -t 30 -i 1 -f m -u -l 1400 -b 20M -R
CAP --out bench/2026-09-25/P1-EV3-S1 --send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/EV3.log' --idle 3 --seconds 40
CAP --out bench/2026-09-25/P1-TK1 --send 'cat /proc/stat ; cat /proc/interrupts' --idle 3 --seconds 20
```
...
```
CAP --out bench/2026-09-25/V1-A --esc 180 --esc-period 0.002 --seconds 200
CAP --out bench/2026-09-25/V1-AB --send 'DW 8040D4A0 1' --idle 2 --seconds 6
CAP --out bench/2026-09-25/V1-HD --send 'DW 80500000 8' --idle 2 --seconds 6
HOST bench/2026-09-25/V1-FL :: FL 10.1.1.1
HOST& bench/2026-09-25/V1-HP :: HP --out bench/2026-09-25/V1-HP --target 10.1.1.1 --seconds 60 --icmp --icmp-interval 0.05 --neigh --tcp 80 --tcp 52869 --tcp 52881
CAP --out bench/2026-09-25/V1-BOOT --send 'J 80500000' --until 'port 80' --seconds 90
HOST bench/2026-09-25/V1-ICMP :: ICMP 10.1.1.1
HOST bench/2026-09-25/V1-NMAP :: timeout 900 nmap -sT -p- -T4 -n --max-retries 1 10.1.1.1
CAP --out bench/2026-09-25/V2-A --esc 180 --esc-period 0.002 --seconds 200
CAP --out bench/2026-09-25/V2-AB --send 'DW 8040D4A0 1' --idle 2 --seconds 6
CAP --out bench/2026-09-25/V2-HD --send 'DW 80500000 8' --idle 2 --seconds 6
HOST bench/2026-09-25/V2-FL :: FL 10.1.1.1
HOST& bench/2026-09-25/V2-HP :: HP --out bench/2026-09-25/V2-HP --target 10.1.1.1 --seconds 60 --icmp --icmp-interval 0.05 --neigh --tcp 80 --tcp 52869 --tcp 52881
CAP --out bench/2026-09-25/V2-BOOT --send 'J 80500000' --until 'port 80' --seconds 90
HOST bench/2026-09-25/V2-ICMP :: ICMP 10.1.1.1
CAP --out bench/2026-09-25/V3-A --esc 180 --esc-period 0.002 --seconds 200
CAP --out bench/2026-09-25/V3-AB --send 'DW 8040D4A0 1' --idle 2 --seconds 6
CAP --out bench/2026-09-25/V3-HD --send 'DW 80500000 8' --idle 2 --seconds 6
HOST bench/2026-09-25/V3-FL :: FL 10.1.1.1
HOST& bench/2026-09-25/V3-HP :: HP --out bench/2026-09-25/V3-HP --target 10.1.1.1 --seconds 60 --icmp --icmp-interval 0.05 --neigh --tcp 80 --tcp 52869 --tcp 52881
CAP --out bench/2026-09-25/V3-BOOT --send 'J 80500000' --until 'port 80' --seconds 90
HOST bench/2026-09-25/V3-ICMP :: ICMP 10.1.1.1
```
...
```
HOST bench/2026-09-25/M1-FL :: FL 10.1.1.1
HOST& bench/2026-09-25/M1-HP :: HP --out bench/2026-09-25/M1-HP --target 10.1.1.1 --seconds 300 --icmp --icmp-interval 0.05 --neigh --tcp 80 --tcp 52869 --tcp 52881
CAP --out bench/2026-09-25/M1-BOOT --until 'port 80' --seconds 300
```
...
```
CAP --out bench/2026-09-25/P2-A --esc 180 --esc-period 0.002 --seconds 200
HOST bench/2026-09-25/P2-FL :: FL 10.1.1.1 ; FL 10.1.1.3
HOST& bench/2026-09-25/P2-HP :: HP --out bench/2026-09-25/P2-HP --target 10.1.1.3 --seconds 300 --icmp --icmp-interval 0.05 --neigh
HOST bench/2026-09-25/P2Q :: LR --cell P2Q QIMG --iterations 2
CAP --out bench/2026-09-25/P2-TK0 --send 'cat /proc/stat ; cat /proc/interrupts' --idle 3 --seconds 20
CAP --out bench/2026-09-25/P2-M0 --send 'echo map 0 > /proc/rtl819x-spi ; cat /proc/rtl819x-spi-map' --until 'map_lines' --seconds 180
HOST bench/2026-09-25/P2-MB0 :: MB bench/2026-09-25/P2-M0
HOST bench/2026-09-25/P2-HPX :: pkill -INT -f 'P2-HP --target' ; sleep 2 ; tail -n 1 bench/2026-09-25/P2-HP.events
HOST bench/2026-09-25/P2-ICMP :: ICMP 10.1.1.3
CAP --out bench/2026-09-25/P2-TK1 --send 'cat /proc/stat ; cat /proc/interrupts' --idle 3 --seconds 20
```
...
```
CAP --out bench/2026-09-25/V4-A --esc 180 --esc-period 0.002 --seconds 200
CAP --out bench/2026-09-25/V4-AB --send 'DW 8040D4A0 1' --idle 2 --seconds 6
CAP --out bench/2026-09-25/V4-WZ --send 'J BFC00000' --esc-after 20 --esc-period 0.002 --until '<RealTek>' --seconds 40
CAP --out bench/2026-09-25/V4-AB2 --send 'DW 8040D4A0 1' --idle 2 --seconds 6
CAP --out bench/2026-09-25/V4-HD --send 'DW 80500000 8' --idle 2 --seconds 6
HOST bench/2026-09-25/V4-FL :: FL 10.1.1.1
HOST& bench/2026-09-25/V4-HP :: HP --out bench/2026-09-25/V4-HP --target 10.1.1.1 --seconds 60 --icmp --icmp-interval 0.05 --neigh --tcp 80 --tcp 52869 --tcp 52881
CAP --out bench/2026-09-25/V4-BOOT --send 'J 80500000' --until 'port 80' --seconds 90
CAP --out bench/2026-09-25/V5-A --esc 180 --esc-period 0.002 --seconds 200
CAP --out bench/2026-09-25/V5-AB --send 'DW 8040D4A0 1' --idle 2 --seconds 6
CAP --out bench/2026-09-25/V5-WZ --send 'J BFC00000' --esc-after 20 --esc-period 0.002 --until '<RealTek>' --seconds 40
CAP --out bench/2026-09-25/V5-AB2 --send 'DW 8040D4A0 1' --idle 2 --seconds 6
CAP --out bench/2026-09-25/V5-HD --send 'DW 80500000 8' --idle 2 --seconds 6
HOST bench/2026-09-25/V5-FL :: FL 10.1.1.1
HOST& bench/2026-09-25/V5-HP :: HP --out bench/2026-09-25/V5-HP --target 10.1.1.1 --seconds 60 --icmp --icmp-interval 0.05 --neigh --tcp 80 --tcp 52869 --tcp 52881
CAP --out bench/2026-09-25/V5-BOOT --send 'J 80500000' --until 'port 80' --seconds 90
CAP --out bench/2026-09-25/V6-A --esc 180 --esc-period 0.002 --seconds 200
CAP --out bench/2026-09-25/V6-AB --send 'DW 8040D4A0 1' --idle 2 --seconds 6
CAP --out bench/2026-09-25/V6-WZ --send 'J BFC00000' --esc-after 20 --esc-period 0.002 --until '<RealTek>' --seconds 40
CAP --out bench/2026-09-25/V6-AB2 --send 'DW 8040D4A0 1' --idle 2 --seconds 6
CAP --out bench/2026-09-25/V6-HD --send 'DW 80500000 8' --idle 2 --seconds 6
HOST bench/2026-09-25/V6-FL :: FL 10.1.1.1
HOST& bench/2026-09-25/V6-HP :: HP --out bench/2026-09-25/V6-HP --target 10.1.1.1 --seconds 60 --icmp --icmp-interval 0.05 --neigh --tcp 80 --tcp 52869 --tcp 52881
CAP --out bench/2026-09-25/V6-BOOT --send 'J 80500000' --until 'port 80' --seconds 90
CAP --out bench/2026-09-25/V7-A --esc 180 --esc-period 0.002 --seconds 200
CAP --out bench/2026-09-25/V7-AB --send 'DW 8040D4A0 1' --idle 2 --seconds 6
CAP --out bench/2026-09-25/V7-WZ --send 'J BFC00000' --esc-after 20 --esc-period 0.002 --until '<RealTek>' --seconds 40
CAP --out bench/2026-09-25/V7-AB2 --send 'DW 8040D4A0 1' --idle 2 --seconds 6
CAP --out bench/2026-09-25/V7-HD --send 'DW 80500000 8' --idle 2 --seconds 6
HOST bench/2026-09-25/V7-FL :: FL 10.1.1.1
HOST& bench/2026-09-25/V7-HP :: HP --out bench/2026-09-25/V7-HP --target 10.1.1.1 --seconds 60 --icmp --icmp-interval 0.05 --neigh --tcp 80 --tcp 52869 --tcp 52881
CAP --out bench/2026-09-25/V7-BOOT --send 'J 80500000' --until 'port 80' --seconds 90
```
...
```
CAP --out bench/2026-09-25/M2-A --esc 180 --esc-period 0.002 --seconds 200
CAP --out bench/2026-09-25/M2-AB --send 'DW 8040D4A0 1' --idle 2 --seconds 6
HOST bench/2026-09-25/M2-FL :: FL 10.1.1.1
HOST& bench/2026-09-25/M2-HP :: HP --out bench/2026-09-25/M2-HP --target 10.1.1.1 --seconds 90 --icmp --icmp-interval 0.05 --neigh --tcp 80 --tcp 52869 --tcp 52881
CAP --out bench/2026-09-25/M2-BOOT --send 'J BFC00000' --until 'port 80' --seconds 90
```
...
```
CAP --out bench/2026-09-25/P3-A --esc 180 --esc-period 0.002 --seconds 200
HOST bench/2026-09-25/P3-FL :: FL 10.1.1.1 ; FL 10.1.1.3
HOST& bench/2026-09-25/P3-TCPD :: timeout 240 sudo -n tcpdump -n -tt -i enxfc19286184c9 'icmp or (arp and arp[6:2] = 1 and arp[18:4] = 0 and arp[22:2] = 0) or (arp and arp[6:2] = 2 and ((arp[8:4] = 0x02524c58 and arp[12:2] = 0x4657) or (arp[8:4] = 0x560a0101 and arp[12:2] = 0x01e8)))'
HOST& bench/2026-09-25/P3-HP :: HP --out bench/2026-09-25/P3-HP --target 10.1.1.3 --seconds 300 --icmp --icmp-interval 0.05 --neigh
HOST bench/2026-09-25/P3Q :: LR --cell P3Q QIMG --iterations 2
CAP --out bench/2026-09-25/P3-TK0 --send 'cat /proc/stat ; cat /proc/interrupts' --idle 3 --seconds 20
CAP --out bench/2026-09-25/P3-M0 --send 'echo map 0 > /proc/rtl819x-spi ; cat /proc/rtl819x-spi-map' --until 'map_lines' --seconds 180
HOST bench/2026-09-25/P3-MB0 :: MB bench/2026-09-25/P3-M0
HOST bench/2026-09-25/P3-HPX :: pkill -INT -f 'P3-HP --target' ; sleep 2 ; tail -n 1 bench/2026-09-25/P3-HP.events
HOST bench/2026-09-25/P3-ICMP :: ICMP 10.1.1.3
CAP --out bench/2026-09-25/P3-TK1 --send 'cat /proc/stat ; cat /proc/interrupts' --idle 3 --seconds 20
HOST bench/2026-09-25/Z9-D2 :: /usr/bin/python3 tools/boot-timeline.py --retro bench/2026-09-25 --tsv bench/2026-09-25/Z9-D2.tsv
bench/2026-09-25/P2Q-r02-ab2
bench/2026-09-25/P2Q-r02-2a
bench/2026-09-25/P2Q-r02-boot
bench/2026-09-25/P3Q-r01-ab2
bench/2026-09-25/P3Q-r01-2a
bench/2026-09-25/P3Q-r01-boot
bench/2026-09-25/P3Q-r02-rz
bench/2026-09-25/P3Q-r02-ab2
bench/2026-09-25/P3Q-r02-2a
bench/2026-09-25/P3Q-r02-boot
```

```cardnum
cells-fence	246	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^bench/2026-09-25/
declared-date	1	count bench/2026-09-25/PREDICTIONS-B46-block44.md [*][*]declared date 2026-09-25[*][*]
another-day	1	count bench/2026-09-25/PREDICTIONS-B46-block44.md [*][*]another day than `bench/2026-09-23/PREDICTIONS-B44-block42[.]md`[*][*]
presses-caught	11	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^CAP -{2}out bench/2026-09-25/[A-Z0-9]+-A -{2}esc 180 -{2}esc-period
presses-listen	1	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^CAP -{2}out bench/2026-09-25/M1-BOOT -{2}until
cap-cells	123	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^CAP -{2}out
host-cells	83	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^HOST&? bench/2026-09-25/
send-over-127	0	count bench/2026-09-25/PREDICTIONS-B46-block44.md -{2}send '[^']{128,}'
no-shell-subst	0	count bench/2026-09-25/PREDICTIONS-B46-block44.md -{2}send '[^']*[$]
no-flr	0	count bench/2026-09-25/PREDICTIONS-B46-block44.md -{2}send '[^']*FLR
no-write-verb	0	count bench/2026-09-25/PREDICTIONS-B46-block44.md -{2}send '[^']*(EW |EB |FLW )
no-burn	0	count bench/2026-09-25/PREDICTIONS-B46-block44.md -{2}send '[^']*AUTOBURN
ifdown-cells	1	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^CAP .*-{2}send '[^']*ifconfig rlx0 down
vendor-jumps	7	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^CAP .*-{2}send 'J 80500000' -{2}until 'port 80'
listen-jbfc	1	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^CAP .*-{2}send 'J BFC00000' -{2}until 'port 80'
head-reads	7	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^CAP .*-{2}send 'DW 80500000 8'
burn-reads	12	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^CAP .*-{2}send 'DW 8040D4A0 1'
tick-reads	6	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^CAP .*-{2}send 'cat /proc/stat ; cat /proc/interrupts'
trial-servers	24	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^CAP .*-{2}send 'iperf3 -s -1 -f k -{2}logfile /tmp/[A-Z]{2}[1-3][.]log
trial-server-check	24	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^CAP .*-{2}send .iperf3 -s -1 [^']* & sleep 2 ; ps ; cat /proc/stat
trial-logs-read	24	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^CAP .*-{2}send 'cat /proc/stat ; busybox killall iperf3 ; sleep 1 ; cat /tmp/[A-Z]{2}[1-3][.]log
dwell-macro	1	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^`LR` = `.* -{2}dwell-seconds 2[.]5`$
tcpdump-cells	2	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^HOST& .* tcpdump -n -tt -i enxfc19286184c9 'icmp or [(]arp and arp\[6:2\] = 1 and arp\[18:4\] = 0 and arp\[22:2\] = 0[)] or [(]arp and arp\[6:2\] = 2 and [(][(]arp\[8:4\] = 0x02524c58 and arp\[12:2\] = 0x4657[)] or [(]arp\[8:4\] = 0x560a0101 and arp\[12:2\] = 0x01e8[)][)][)]'$
...
no-ab-gates	0	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^gate:grep=.8040D4A0
hd-gates	7	count bench/2026-09-25/PREDICTIONS-B46-block44.md ^gate:grep=.80500010:
