...
🟢 **`CI-5` 第四個資料點,而它讓那條結論更強而不是只是重複它:**

| run | wall | `instruments` exec | `apt` |
|---|---:|---:|---:|
| `33595236873`(09-02) | 14:32 | 560 s | 24 s |
| `33657418793`(09-02) | 9:35 | 561 s | 24 s |
| `33657603686`(09-02) | 19:59 | 1183 s | **650 s** |
| 🆕 `33747027566`(今天) | **9:37** | **562 s** | 29 s |

**suite 那一側三天四次落在 560–562 s,±0.4 %;wall 的 26 倍變異全在 `apt`。**
